...
And here we can first layer has 4 perceptrons with 15 weights each, 2nd layer has 2 perceptrons with 4 weights each, output layer has 1 perceptron with 2 weights, and all of the layers have 1 bias term each
...
**Updating Coefficients** will simply loop over all coeff and biases and subtracting $graddient * learningRate$
